...
nohup python run_fasttext.py train > fasttext_1w_ori.log 2>&1 
nohup python run_cnn.py train > cnn_1w_ori.log 2>&1 
...
nohup python run_fasttext.py train > fasttext_1w_aug.log 2>&1 
nohup python run_cnn.py train > cnn_1w_aug.log 2>&1 

head -q -n 50000 data/data_train_fasttext.txt.ori > data/data_train_fasttext.txt
nohup python run_fasttext.py train > fasttext_5w_ori.log 2>&1 
nohup python run_cnn.py train > cnn_5w_ori.log 2>&1 
...
nohup python run_fasttext.py train > fasttext_5w_aug.log 2>&1 
nohup python run_cnn.py train > cnn_5w_aug.log 2>&1 

head -q -n 100000 data/data_train_fasttext.txt.ori > data/data_train_fasttext.txt
nohup python run_fasttext.py train > fasttext_10w_ori.log 2>&1 
nohup python run_cnn.py train > cnn_10w_ori.log 2>&1 
...
nohup python run_fasttext.py train > fasttext_10w_aug.log 2>&1 
nohup python run_cnn.py train > cnn_10w_aug.log 2>&1 
